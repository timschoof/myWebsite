...
### RMarkdown and LaTeX
To get to grips with the basics of RMarkdown, check out the [tutorial](https://rmarkdown.rstudio.com/lesson-1.html) on the RStudio website. It's quite short. There's also a very handy [cheat sheet](https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf) for when you've forgotten how to create a new header or a numbered list, or how to use italics.
